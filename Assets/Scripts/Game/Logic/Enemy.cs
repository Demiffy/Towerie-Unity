...
public class Enemy : MonoBehaviour
{
	...
	public void TakeDamage(int damage, bool canSeeCamo)
	{
		if (isCamouflaged && !canSeeCamo)
		{
			Debug.Log("Enemy is camouflaged and cannot be damaged by this tower.");
			return;
		}
	...
	private IEnumerator PoisonCoroutine(int damageOverTime, float duration)
	{
		...
		while (duration > 0)
		{
			TakeDamage(damageOverTime, false);
